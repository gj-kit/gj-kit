...
앱이 API와 저장소 정책을 직접 소유하면서 미디어 선택, 업로드 준비, 해싱, 기기 라이브러리, 지속 로컬 파일을 다룰 때 사용합니다.
...
presigned URL이나 native URI 세부 정보를 공개 오류에 노출하지 말고, 정리 권한과 attachment 트랜잭션은 소비 앱에 둡니다.

## 문서

- [패키지 가이드](https://gj-kit.github.io/gj-kit/ko/packages/expo-media/)
- [전체 API 명세](https://gj-kit.github.io/gj-kit/ko/api/expo-media/)
- [기계 판독 API JSON](https://gj-kit.github.io/gj-kit/api/expo-media.json)
