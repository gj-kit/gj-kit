#!/usr/bin/env node
/**
 * Write the source-commit identity that is shipped with every expo-workouts
...
if (manifest.name !== '@gj-kit/expo-workouts' || typeof manifest.version !== 'string') {
  throw new Error('expo-workouts package identity is invalid; refusing to stamp provenance.');
}
