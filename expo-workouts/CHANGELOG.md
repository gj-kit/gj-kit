...
- 6f10806: 신규 패키지 — HealthKit(iOS) / Health Connect(Android) 워크아웃과 GPS 루트를 위한 첫 네이티브 Expo 모듈. 갭 없는 증분 동기화 프로토콜, 멱등 쓰기, 스트리밍 루트를 제공한다. **런타임 의존성 0.**
