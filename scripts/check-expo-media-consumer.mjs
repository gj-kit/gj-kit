 ...
 *
 * The shared harness hands the actual npm tarball to a new Expo SDK 56 app, so
 * Metro resolves web/iOS/Android conditions instead of this repository's
 * workspace source. This remains separate from ordinary unit tests because it
 * installs Expo and takes minutes rather than milliseconds.
 */
