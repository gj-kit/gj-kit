#!/usr/bin/env node
/**
 * Write the source-commit identity that is shipped with every expo-auth
...
if (manifest.name !== '@gj-kit/expo-auth' || typeof manifest.version !== 'string') {
  throw new Error('expo-auth package identity is invalid; refusing to stamp provenance.');
}
